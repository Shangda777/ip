...
public class AiHelper {
    ...
    private static final String SYSTEM_PROMPT =
            ...
            + "Use the prefix exactly as shown (uppercase, followed by a colon).\n"
            + "If you are not sure what command to generate, do NOT output COMMAND:, "
            + "instead ask a short clarifying question.\n\n"
            + "Available commands:\n"
            + "1. todo <description>\n"
